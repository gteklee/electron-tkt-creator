...
let Forms = new function()
{
    ...
    this.checkSubmittable = function()
    {
        ...
        let blank = false;
        ids.forEach(element => {
            if((element === 'info_confirm_survey' && $('#input-info_confirm_survey').is(':checked')) || (element === 'info_confirm_install' && $('#input-info_confirm_install').is(':checked')) || (element === 'info_confirm_relo' && $('#input-info_confirm_relo').is(':checked')) || (element === 'cst_id' && $('#input-cst_status-new').is(':checked')) || element === 'cst_site' || element === 'mtl_mac' || element === 'mtl_dhcp' || element === 'mtl_queue' || element === 'mtl_queue_max' || element === 'mtl_snr' || element === 'mtl_ap' || element === 'mtl_ap_uptime' || element === 'mtl_queue_max' || element === 'voip_mac' || element === 'voip_public' || element === 'job_occupancy' || element === 'job_population' || element === 'job_reason_survey' || element === 'tkt_notes' || element === 'tkt_reason_static' || element === 'voip_callid' || element === 'radio_ap_count' || element === 'radio_ssid' || element === 'radio_quality' || element === 'radio_ccq' || element === 'radio_signal_last' || element === 'radio_signal' || element === 'radio_speedtest' || element === 'cst_torch' || element === 'cst_speedtest' || element === 'special_equipment') {} // Skip
            else { 
