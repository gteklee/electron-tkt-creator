let Towers = new function()
{
    ...
    this.cleanTowerList = function()
    {
        ...
        {
            if(this.towers[i].id == 59 || this.towers[i].id == 60 || this.towers[i].id == 61 || this.towers[i].id == 66 || this.towers[i].id == 75 || this.towers[i].id > 85 && this.towers[i].id < 88)
            {
    ...
    this.createZones = function()
    {
        ...
        {
            // Zone 1
            // 7, 8, 16, 25, 26 31, 33, 39, 40, 41, 42, 45, 48, 55, 59, 65, 68, 70, 76, 78, 79, 84
            if(this.towers[i].id == 7 || this.towers[i].id == 8 || this.towers[i].id == 16 || this.towers[i].id == 25 || this.towers[i].id == 26 || this.towers[i].id == 31 || this.towers[i].id == 33 || this.towers[i].id == 39 || this.towers[i].id == 40 || this.towers[i].id == 41 || this.towers[i].id == 42 || this.towers[i].id == 45 || this.towers[i].id == 48 || this.towers[i].id == 55 || this.towers[i].id == 59 || this.towers[i].id == 65 || this.towers[i].id == 68 || this.towers[i].id == 70 || this.towers[i].id == 76 || this.towers[i].id == 78 || this.towers[i].id == 79 || this.towers[i].id == 84)
            {
                this.Zones.zone_1.push(this.towers[i]);
            }
            else if(this.towers[i].id == 21 || this.towers[i].id == 34 || this.towers[i].id == 35 || this.towers[i].id == 51 || this.towers[i].id == 54 || this.towers[i].id == 56 || this.towers[i].id == 58 || this.towers[i].id == 72 || this.towers[i].id == 83 || this.towers[i].id == 88)
            { // Zone 2
            ...
            else if(this.towers[i].id == 5 || this.towers[i].id == 6 || this.towers[i].id == 13 || this.towers[i].id == 15 || this.towers[i].id == 22 || this.towers[i].id == 27 || this.towers[i].id == 30 || this.towers[i].id == 36 || this.towers[i].id == 37 || this.towers[i].id == 44 || this.towers[i].id == 57 || this.towers[i].id == 71 || this.towers[i].id == 73 || this.towers[i].id == 85)
            { // Zone 4
              // 5, 6, 13, 15, 22, 27, 30, 36, 37, 44, 57, 71, 73, 85
