    ...
    this.Handler = new function()
    {
        ...
        this.form = {
            ...
            clear: function()
            {
                ...
                // 'Other' text input
                $('#input-job_wifi-text').val('').attr('disabled', true);
                // job_wifi radio buttons
                $('input[type=radio][name=job_wifi]:checked').prop('checked', false);
            },
            ...
            submit: function()
            {
                ...
                for(let prop in this.that.getTicketData()) {
                    ...
                    else if(prop === 'job_wifi') {
                        if($('#input-job_wifi-yes').is(':checked')) {
                            this.that.setTicketDataProperty(prop, 'Yes');
                        } else if($('#input-job_wifi-no').is(':checked')) {
                            this.that.setTicketDataProperty(prop, 'No');
                        } else if($('#input-job_wifi-other').is(':checked')) {
                            this.that.setTicketDataProperty(prop, 'Other: ' + $('#input-job_wifi-text').val());
                        }
                    }
                    else {
...
/**
 * On job wifi option update, disable / enable 
 * appropriate fields.
 */
$('#input-job_wifi-yes').on('change', () => {
    if($('#input-job_wifi-yes').is(':checked')) {
        $('#input-job_wifi-text').attr('disabled', true).val('');
    }
});

$('#input-job_wifi-no').on('change', () => {
    if($('#input-job_wifi-no').is(':checked')) {
        $('#input-job_wifi-text').attr('disabled', true).val('');
    }
});

$('#input-job_wifi-other').on('change', () => {
    if($('#input-job_wifi-other').is(':checked')) {
        $('#input-job_wifi-text').attr('disabled', false);
    }
});