...
$other.on('click', event => {
    ...
    else if(section != 'option-repair' && section != 'option-onsite' && section != 'option-home' && section != 'option-static' && section != 'option-key' && section != 'option-voip' && section != 'option-mtl') return; // For release with only repair tickets,
